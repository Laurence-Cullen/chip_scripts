...
def main(fid):
    ...
    #Plot attempt
    x, y, z = fid_to_coords(fid, 1, collect_ordr_dict)
    print x.shape, y.shape, z.shape
    gridsize=4
    plt.subplot(111, aspect=1, axisbg='k')
    plt.scatter(x, y, c=z, s=50, alpha=1, marker='s', cmap='PuOr')

    #plt.scatter(x, y, c=z, s=60, alpha=0.5, marker='s', norm=matplotlib.colors.LogNorm())
